...
<head>
    ...
    <title>Dashboard Students Skill Vortex</title>
                                        ...
                                        <div class="card-body">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="d-flex justify-content-center mt-5">
                                                    ...
                                                    <button name="cancelbtn" type="button" onclick="window.location='./materi.php'" class="btn btn-danger mx-3">Cancel</button>
                                                </div>
                                                ...
                                                <?php
                                                    if (isset($_POST['submitTugas']))
                                                    {
                                                        ...
                                                        $dataArr = array(
                                                            ...
                                                            'kode_course' => $_SESSION['kode_tugas'],
