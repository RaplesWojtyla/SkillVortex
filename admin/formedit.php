...
<head>
    ...
    <title>Form Edit Skill Vortex</title>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <?php
                                ...
                                {
                                    $userID = $_POST['id'];
                                    $res = query("SELECT * FROM users WHERE id_users = '$userID'");
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input name="namaLengkap" type="text" class="form-control" value="<?=$data['nama_lengkap']?>"
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    ...
                                                    <input name="user_level" type="text" class="form-control" value="<?=$data['level']?>"
                                                        id="email-horizontal-icon" hidden>
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    ...
                                                    <input name="id" type="text" class="form-control" value="<?=$userID?>"
                                                        id="password-horizontal-icon" hidden>
                                                    <div class="form-control-icon">
