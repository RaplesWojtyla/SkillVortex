                                    ...
                                    <tbody>
                                        ...
                                        <?php } else {?>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" name="sendRemainder" id="sr<?=str_replace(' ', '', $data1['nama_student'])?>" onclick="sendEmail('e<?=str_replace(' ', '', $data1['nama_student'])?>', 'p<?=str_replace(' ', '', $data1['nama_student'])?>', 'sr<?=str_replace(' ', '', $data1['nama_student'])?>')" class="btn btn-danger">
